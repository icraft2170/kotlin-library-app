...
class BookServiceTest @Autowired constructor (
    ...
    fun loanBookFailTest() {
        ...
        userLoanHistoryRepository
            .save(UserLoanHistory.fixture(savedUser))
        val request = BookLoanRequest("Hero", "이상한 나라의 엘리스")
    ...
    @Test
    @DisplayName("책 대여 개수를 정상 확인한다.")
    fun countLoanedBookTest() {
        //given
        val savedUser = userRepository.save(User("Hero", null))
    ...
    private fun assertCount(results: List<BookStatsResponse>, type: BookType, count: Long) {
